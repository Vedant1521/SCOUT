...
std::experimental::optional<std::string> SNIExtractor::extract(const uint8_t* payload, size_t length) {
...
std::experimental::optional<std::string> HTTPHostExtractor::extract(const uint8_t* payload, size_t length) {
...
std::experimental::optional<std::string> DNSExtractor::extractQuery(const uint8_t* payload, size_t length) {
    ...
    return domain.empty() ? std::experimental::optional<std::string>() : std::experimental::optional<std::string>(domain);
}
...
std::experimental::optional<std::string> QUICSNIExtractor::extract(const uint8_t* payload, size_t length) {
