...
public:
    ...
    static std::experimental::optional<std::string> extract(const uint8_t* payload, size_t length);
...
public:
    ...
    static std::experimental::optional<std::string> extractQuery(const uint8_t* payload, size_t length);
